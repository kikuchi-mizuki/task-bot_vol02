    ...
    def extract_dates_and_times(self, text):
        ...
        try:
            ...
            system_prompt = (
                ...
                "\n"
                "【時間条件の認識について】\n"
                "「来週の19時以降」という入力があった場合、必ず以下のように処理してください：\n"
                "1. 来週の7日間（月曜日〜日曜日）を計算\n"
                "2. 各日付に対して「19:00〜23:59」の時間条件を設定\n"
                "3. 決して「00:00〜23:59」にしてはいけません\n"
                "\n"
                "【具体例】\n"
                "入力：「来週の19時以降」\n"
                "出力：{\n"
                ...
                "  \"dates\": [\n"
                "    {\"date\": \"2025-10-27\", \"time\": \"19:00\", \"end_time\": \"23:59\"},\n"
                "    {\"date\": \"2025-10-28\", \"time\": \"19:00\", \"end_time\": \"23:59\"},\n"
                "    {\"date\": \"2025-10-29\", \"time\": \"19:00\", \"end_time\": \"23:59\"},\n"
                "    {\"date\": \"2025-10-30\", \"time\": \"19:00\", \"end_time\": \"23:59\"},\n"
                "    {\"date\": \"2025-10-31\", \"time\": \"19:00\", \"end_time\": \"23:59\"},\n"
                "    {\"date\": \"2025-11-01\", \"time\": \"19:00\", \"end_time\": \"23:59\"},\n"
                "    {\"date\": \"2025-11-02\", \"time\": \"19:00\", \"end_time\": \"23:59\"}\n"
                "  ]\n"
                "}\n"
                "\n"
                ...
                "   **「来週の19時以降」は必ず「19:00〜23:59」として抽出し、00:00〜23:59にしてはいけません**\n"
